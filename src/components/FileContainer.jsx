...
import Receipt from '../static/images/receipt.png';
import { Link } from 'react-router-dom';
const FileContainer = ({index, onCancel,url = '', showCancel = true}) => {
    return (
        <Flex
            w={'84px'}
            h={'84px'}
            borderRadius={'4px'}
            border={'0.974px solid rgba(0, 0, 0, 0.05)'}
